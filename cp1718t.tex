...
\\[\blanklineskip]%
\>[B]{}\Varid{geneCompress}\mathbin{::}(\Conid{Int},\Conid{QTree}\;\Varid{a})\to (\Varid{a},(\Conid{Int},\Conid{Int}))+((\Conid{Int},\Conid{QTree}\;\Varid{a}),((\Conid{Int},\Conid{QTree}\;\Varid{a}),((\Conid{Int},\Conid{QTree}\;\Varid{a}),(\Conid{Int},\Conid{QTree}\;\Varid{a})))){}\<[E]%
\\
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Conid{Retorna}\;\Varid{um}\;\Varid{valor}\;\Varid{qualquer}\;\Varid{de}\;\Varid{uma}\;\Conid{QTree}\comp \Conid{Precisamos}\;\Varid{disto}\;\Varid{para}\;\Varid{a}\;\Varid{compress},\Varid{para}\;\Varid{escolher}\;\Varid{um}\;\Varid{valor}\;\Varid{qualquer}\;\Varid{para}\;\Varid{o}\;\Conid{Block}\;\Varid{pai}\;\Varid{ao}\;\Varid{tirar}\;\Varid{os}\;\Varid{filhos}\comp {}\<[E]%
\\
...
%
    ...
    \ensuremath{\begin{lcbr}\Varid{lk}\comp \underline{\mathrm{0}}\mathrel{=}\underline{\mathrm{1}}\\\Varid{lk}\comp \succ \mathrel{=}\succ \comp \Varid{lk}\end{lcbr}}
%
\just\equiv{ Lei Eq-+ }
%
...
\just\equiv{ Definição de in dos naturais, Lei da Fusão e Lei da Absorção }
%
    \ensuremath{\begin{lcbr}\Varid{g}\comp \mathbf{in}\mathrel{=}\alt{\underline{\mathrm{1}}}{\Varid{mul}}\comp (\Varid{id}\mathbin{+}\conj{\Varid{s}}{\Varid{g}})\\\Varid{s}\comp \mathbf{in}\mathrel{=}(\alt{\underline{(\Varid{k}\mathbin{+}\mathrm{1})}}{\succ }\comp \p1)\comp (\Varid{id}\mathbin{+}\conj{\Varid{s}}{\Varid{g}})\end{lcbr}}
%
\just\equiv{ A ver depois mas será aplicação de swap e de cancelamento-X }
%
...
%
	\ensuremath{\conj{\cata{\Varid{i}~\cdot }_A}{\cata{\Varid{j}~\cdot }_A}\mathrel{=}\cata{\conj{\alt{\underline{\mathrm{1}}}{\Varid{mul}\comp \Varid{swap}}}{\alt{\underline{(\Varid{k}\mathbin{+}\mathrm{1})}}{\succ \comp \p2}}\times\conj{\alt{\underline{\mathrm{1}}}{\Varid{mul}\comp \Varid{swap}}}{\alt{\underline{\mathrm{1}}}{\succ \comp \p1\comp \Varid{swap}}}~\cdot }_A}
%
\just\equiv{ Lei da Troca }
%

    \ensuremath{\conj{\cata{\Varid{i}~\cdot }_A}{\cata{\Varid{j}~\cdot }_A}\mathrel{=}\cata{\alt{\conj{\underline{\mathrm{1}}}{\underline{(\Varid{k}\mathbin{+}\mathrm{1})}}}{\conj{\Varid{mul}\comp \Varid{swap}}{\succ \comp \p2}}\times\alt{\conj{\underline{\mathrm{1}}}{\underline{\mathrm{1}}}}{\conj{\Varid{mul}\comp \Varid{swap}}{\succ \comp \p1\comp \Varid{swap}}}~\cdot }_A}
%
