...
\just\equiv{ Definição de in dos naturais, Lei da Fusão e Lei da Absorção }
%
    \ensuremath{\begin{lcbr}\Varid{g}\comp \mathbf{in}\mathrel{=}\alt{\underline{\mathrm{1}}}{\Varid{mul}}\comp (\Varid{id}\mathbin{+}\conj{\Varid{s}}{\Varid{g}})\\\Varid{lk}\comp \mathbf{in}\mathrel{=}(\alt{\underline{(\Varid{k}\mathbin{+}\mathrm{1})}}{\succ }\comp \p1)\comp (\Varid{id}\mathbin{+}\conj{\Varid{s}}{\Varid{g}})\end{lcbr}}
%
\just\equiv{ A ver depois mas será aplicação de swap e de cancelamento-X }
%
