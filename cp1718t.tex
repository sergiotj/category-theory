...
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment  allTransactions usa um catamorfismo que basicamente só usa o p2}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  para extrair as listas de transações de cada bloco}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  o conc concatena duas listas recebidas num tuplo}{}\<[E]%
\\
...
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment  Para calcular o ledger vamos fazer 3 passos:}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  1. Obter a lista das transações de uma blockchain (usando allTransactions)}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  2. Obter uma lista de entidades a partir da lista de transações (usando catamorfismo getEntities)}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  3. Eliminar repetições da lista de entidades}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  4. Obter o ledger}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment  Diagrama:}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment }{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  Blockchain}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  /}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  / allTransactions}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  v}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  [transaction]}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  /}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  / <getUniqueEntities, id>}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  v}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  ([entity], [transaction])}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  /}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  / id >< getBalance}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  v}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  ([entity], (getBalance [transaction]))}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  /}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  / <p1, mapPair . swap>}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  v}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  ([entity], [saldo])}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  /}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  / zipPair}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  v}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  [(entity, saldo)]  <-- Ledger!!}{}\<[E]%
\\[\blanklineskip]%
...
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment  Catamorfismo de listas que calcula um conjunto de entidades a partir de uma lista de transações}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  Transação: (origem, (valor, destino))}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  Transação para lista com as duas entidades: pairToList . (split p1 (p2 . p2))}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  Gene: [nil, conc . (funcaoDaLinhaAcima >< id)]}{}\<[E]%
\\
...
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment  Remove repetições de uma lista de entidades}{}\<[E]%
\\
...
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment  Catamorfismo (de listas de transações) que calcula o saldo de uma dada entidade}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  Não é pointfree porque tem de receber a lista de transações antes da entidade,}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  para nos dar jeito para o map que vamos querer fazer.}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  Usamos const 0 em vez de Cp.zero porque o do professor retorna Integer em vez de Int}{}\<[E]%
\\
...
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment  delta: Retorna a diferença de saldo resultante de uma transação,}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  para uma dada entidade (se a entidade não aparece na transação, delta = 0)}{}\<[E]%
\\
...
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment  addInt em vez de add porque add recebe Integer,}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  e fazer conversões ia ficar confuso}{}\<[E]%
\\
\>[B]{}\Varid{addInt}\mathbin{::}(\Conid{Int},\Conid{Int})\to \Conid{Int}{}\<[E]%
\\
\>[B]{}\Varid{addInt}\;(\Varid{a},\Varid{b})\mathrel{=}\Varid{a}\mathbin{+}\Varid{b}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment  Remove elementos duplicados de uma lista}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  encontrada no stack overflow, muito fixe!!!}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  nub: O(N^2), remDup: O(N log N)}{}\<[E]%
\\
...
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment  Diagrama do isValidMagicNr:}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  (verifica se os números mágicos de}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  uma blockchain são únicos)}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment }{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  Blockchain}{}\<[E]%
...
\>[B]{}\mbox{\onelinecomment  /}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  / getMagicNumbers (catamorfismo)}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  v}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  [String]}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  /}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  / checkDuplicates (catamorfismo)}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  v}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  Bool}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{isValidMagicNr}\mathrel{=}\Varid{checkDuplicates}\comp \Varid{getMagicNumbers}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment  Este cataBlockchain que retorna a lista de números mágicos é um}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  bocado manhoso! Temos de explicar bem o caso final, que faz cons . (split p1 nil)}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  para retornar uma lista só com o número mágico do último bloco lá dentro}{}\<[E]%
\\
...
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment  Verifica duplicados, esta é pointwise}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  porque são 19:47 e passamos o dia na biblioteca,}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  estamos cansados, e assim fica bonita, não tem mal nenhum :'(}{}\<[E]%
\\
...
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment  Blockchain de teste}{}\<[E]%
\\
\>[B]{}\Varid{block1}\mathrel{=}(\text{\ttfamily \char34 1234\char34},(\mathrm{177777},[\mskip1.5mu (\text{\ttfamily \char34 Marcos\char34},(\mathrm{200},\text{\ttfamily \char34 Tarracho\char34})),(\text{\ttfamily \char34 Antonio\char34},(\mathrm{200},\text{\ttfamily \char34 Joao\char34})),(\text{\ttfamily \char34 Tarracho\char34},(\mathrm{200},\text{\ttfamily \char34 Marcos\char34})),(\text{\ttfamily \char34 Marcos\char34},(\mathrm{200},\text{\ttfamily \char34 Tarracho\char34}))\mskip1.5mu])){}\<[E]%
\\
...
\\
\>[B]{}\mbox{\onelinecomment  testBlockchain = Bcs (block1, Bc block2)}{}\<[E]%
\\
\>[B]{}\Varid{testBlockchain}\mathrel{=}\Conid{Bcs}\;(\Varid{block3},\Conid{Bcs}\;(\Varid{block1},\Conid{Bc}\;\Varid{block2})){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment compressQTree comp =  cataQTree (either (compressCell comp) toBlock)}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment compressCell red (a,(b,c)) = if (red > (depthQTree((Cell a b c)))) then (Cell a b c) else (Cell a 0 0)}{}\<[E]%
\\
...
\\
\>[5]{}\hsindent{6}{}\<[11]%
\>[11]{}\Varid{tuple}\;(\Varid{a},\Varid{b},\Varid{c},\Varid{d})\mathrel{=}((\Varid{a},\Varid{b}),(\Varid{c},\Varid{d})){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment  Lei 47: def-map-cata}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  Tf = (\ensuremath{\mathbf{in}\comp \mathit B\;(\Varid{f},\Varid{id})})}{}\<[E]%
\\
...
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment  Fiz o diagrama do anamorfismo de FTree para fazer}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  a generatePTree, que devemos incluir no relatório}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  para se perceber como foi criado o gene.}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment  generatePTree é um anamorfismo de FTree}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  (pode ser FTree em vez de PTree porque}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  (type PTree = FTree Square Square)}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment  O gene é uma função que passa Int}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  (profundidade da PTree que queremos gerar) para}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  Float + (Float, (Int, Int))}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  Porque no fim queremos usar o in da FTree}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  para ficar com uma PTree (por isso é que aparecem Floats)}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment  O rank recebido pela generatePTree tem de ir diminuindo}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  à medida que o anamorfismo corre, por isso o gene não}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  pode aumentar o Int original. Caso contrário, não}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  saberíamos quando é que devíamos parar.}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  Isto significa que a árvore vai ser gerada}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  das folhas para a raiz.}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{generatePTree}\mathrel{=}\Varid{anaFTree}\;\Varid{genePTree}\comp \conj{\underline{\mathrm{0}}}{\Varid{id}}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment  Primeira tentativa, dava uma árvore invertida}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  genePTree = (id -\ensuremath{\mathbin{-}\conj{\p2}{\conj{\p1}{\p1}})\comp (\Varid{id}\mathbin{-}}- (pred >< id)) . (id -\ensuremath{\mathbin{-}\conj{\Varid{id}}{\Varid{rankToMultiplier}})\comp (\Varid{fromIntegral}\mathbin{-}}- id) . oneToLeft}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{genePTree}\mathrel{=}(\Varid{id}+(\Varid{id}\times\conj{\Varid{id}}{\Varid{id}}))\comp (\Varid{id}+(\Varid{id}\times(\succ \times\Varid{id})))\comp (\Varid{id}+\conj{\Varid{rankToMultiplier}\comp \p1}{\Varid{id}})\comp ((\Varid{rankToMultiplier}\comp \p1)+\Varid{id})\comp \Varid{checkComplete}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment  Retorna o multiplicador de uma PTree}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  para um dado Rank. Por exemplo, o multiplicador}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  de ordem 0 é 1, o de ordem 1 é (raiz de 2)/2,}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  e o de ordem 2 é ((raiz de 2)/2)^2}{}\<[E]%
\\
...
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment  Se um par tem dois Ints iguais,}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  mete à esquerda, senão mete à direita}{}\<[E]%
\\
...
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mid \Varid{b}\mathbin{<}\mathrm{0}\mathrel{=}i_1\;(\Varid{a},\mathrm{0})\mbox{\onelinecomment  Evitar loop infinito com má iput (rank negativo)}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
